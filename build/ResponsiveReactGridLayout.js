...
var ResponsiveReactGridLayout = /*#__PURE__*/function (_React$Component) {
  ...
  function ResponsiveReactGridLayout() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onLayoutInit", function (layout
    /*: Layout*/
    ) {
      if (_this.props.onLayoutInit) {
        _this.props.onLayoutInit(layout);
      }
    });
  ...
  _createClass(ResponsiveReactGridLayout, [{
    ...
    /*: Props<*>*/
      ...
      if (lastBreakpoint !== newBreakpoint || prevProps.breakpoints !== breakpoints || prevProps.cols !== cols) {
        ...
        var _layout = (0, _responsiveUtils.findOrGenerateResponsiveLayout)(newLayouts, breakpoints, newBreakpoint, lastBreakpoint, newCols, compactType); // This adds missing items.


        _layout = (0, _utils.synchronizeLayoutWithChildren)(_layout, this.props.children, newCols, compactType, this.props.allowOverlap); // Store the new layout.

        newLayouts[newBreakpoint] = _layout; // callbacks
